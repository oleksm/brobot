...
<html>
    ...
    <body>
        ...
        <div id="show-ticker" class="content scaffold-show" role="main">
            ...
            <f:display bean="ticker" />
            <g:form resource="${this.ticker}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ticker}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
